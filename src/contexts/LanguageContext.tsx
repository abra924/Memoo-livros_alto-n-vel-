...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'footer.rights': '© 2026 Memoo Livros. Digital Curation.',
    'privacy.title': 'Privacy Policy',
    'privacy.back': 'Back',
    'privacy.badge': 'Privacy & Security',
    'privacy.subtitle': 'At Memoo Livros, transparency is our main pillar. Learn how we protect your data and your identity.',
    'terms.title': 'Terms of Service',
    'terms.badge': 'Legal Agreements',
    'terms.subtitle': 'By using Memoo Livros, you agree to the terms described below. These ensure the quality and security of all our curators.',
    'about.title': 'Transforming the way the world ',
    'about.title_highlight': 'learns',
    'about.badge': 'Our Story',
    'about.subtitle': 'Memoo Livros was born from the need to filter digital noise and deliver only what really matters for your personal and professional evolution.',
  ...
  ao: {
    ...
    'footer.rights': '© 2026 Memoo Livros. Curadoria Digital.',
    'privacy.title': 'Política de Privacidade',
    'privacy.back': 'Voltar',
    'privacy.badge': 'Privacidade e Segurança',
    'privacy.subtitle': 'Na Memoo Livros, a transparência é o nosso principal pilar. Saiba como protegemos os seus dados e a sua identidade.',
    'terms.title': 'Termos de Serviço',
    'terms.badge': 'Acordos Legais',
    'terms.subtitle': 'Ao utilizar a Memoo Livros, concorda com os termos descritos abaixo. Estes asseguram a qualidade e a segurança de todos os nossos curadores.',
    'about.title': 'Transformando a forma como o mundo ',
    'about.title_highlight': 'aprende',
    'about.badge': 'A Nossa História',
    'about.subtitle': 'A Memoo Livros nasceu da necessidade de filtrar o ruído digital e entregar apenas o que realmente importa para a tua evolução pessoal e profissional.',
